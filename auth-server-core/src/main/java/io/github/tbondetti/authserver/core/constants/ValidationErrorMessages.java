...
public class ValidationErrorMessages {
    ...
    public static final String ERROR_CLIENT_NAME_IS_TOO_LONG = "Le nom du client ne doit pas dépasser les " + CLIENT_NAME_MAX_LENGTH + " caractères.";
    ...
    public static final String ERROR_SCOPE_CODE_TOO_LONG = "Le code du scope ne doit pas dépasser les "
            + SCOPE_CODE_MAX_LENGTH + " caractères.";
