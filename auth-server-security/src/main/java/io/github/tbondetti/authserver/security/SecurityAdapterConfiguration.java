package io.github.tbondetti.authserver.security;
...
import io.github.tbondetti.authserver.security.encoder.PasswordEncoderAdapter;
import io.github.tbondetti.authserver.security.oauth2.OAuth2ClientCredentialsGeneratorAdapter;
import io.github.tbondetti.authserver.security.oauth2.OAuth2RegisteredClientRepository;
import io.github.tbondetti.authserver.security.userdetails.AuthServerUserDetailsService;
...
public class SecurityAdapterConfiguration {
    ...
    RegisteredClientRepository registeredClientRepository(
        ...
        return new OAuth2RegisteredClientRepository(oauth2ClientRepositoryPort, oauth2ScopeRepositoryPort);
    }
